...
export class EP7HowFearAndFailureAffectsOurMinds extends Component {
  constructor(props: any) {
    super(props);
  ...
  render() {
    ...
    const track = {
      ...
      artist: 'Julius Reade',
      albumArtUrl: "https://neverfapdeluxe.com/images/logo.png",
      audioUrl: "https://s3.castbox.fm/e2/0a/8b/6092734ceca0ce9e459be3f342.mp3",
...
export default { EP1MyPersonalNoFapPornRecoveryJourney,EP2WhatExactlyConstitutesAsRelapse,E03HowToBecomeComfortableWithYourEmotions,EP4HowAwarenessHelpsUsRemainInControl,E05TheImportanceOfMaintainingBalance,EP6TheFallacyOfJudgementAndSelfCriticism,EP7HowFearAndFailureAffectsOurMinds, }
