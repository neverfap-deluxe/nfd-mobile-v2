...
export class EP0ObserveYourSensespilot extends Component {
...
export class EP1ObserveYourSenses extends Component {
  constructor(props: any) {
    super(props);
  ...
  render() {
    ...
    const track = {
      ...
      artist: 'Julius Reade',
      albumArtUrl: "https://neverfapdeluxe.com/images/logo.png",
      audioUrl: "https://s3.castbox.fm/61/6f/59/95055247d0b6fe18ccc053aaec.mp3",
...
export default { EP0ObserveYourSensespilot,EP1ObserveYourSenses, }
