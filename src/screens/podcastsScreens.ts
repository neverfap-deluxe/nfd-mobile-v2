  ...
  import { EP7HowFearAndFailureAffectsOurMinds,EP6TheFallacyOfJudgementAndSelfCriticism,E05TheImportanceOfMaintainingBalance,EP4HowAwarenessHelpsUsRemainInControl,E03HowToBecomeComfortableWithYourEmotions,EP2WhatExactlyConstitutesAsRelapse,EP1MyPersonalNoFapPornRecoveryJourney, } from '../content/podcasts/index.tsx'
  const PodcastsScreens = new Map();

  export const EP7HOWFEARANDFAILUREAFFECTSOURMINDS_SCREEN = 'navigation.EP7HowFearAndFailureAffectsOurMindsScreen';
...
export const EP1MYPERSONALNOFAPPORNRECOVERYJOURNEY_SCREEN = 'navigation.EP1MyPersonalNoFapPornRecoveryJourneyScreen';
  ...
  PodcastsScreens.set(EP7HOWFEARANDFAILUREAFFECTSOURMINDS_SCREEN, EP7HowFearAndFailureAffectsOurMinds);
